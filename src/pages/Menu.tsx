        ...
        <div>
          ...
          {price.single && (
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="double" id={`${name}-double`} />
          ...
          {!price.single && (
            <p className="mb-4">Endless Cup ${price.endless.toFixed(2)}</p>
          )}
        </div>
...
const menuItems = [
  {
    ...
    price: { endless: 2.0 },
    image:
      "https://www.giesen.com/wp-content/uploads/2020/12/shosuke-takahashi-f6-XQoheD50-unsplash-1024x682.jpg",
  },
  {
    name: "Cafe au Lait",
    Icon: Milk,
    ...
    image:
      "https://www.thespruceeats.com/thmb/YEI_JAfLHd6fbfCYUukcW5E2TYg=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/SES-cafe-au-lait-recipe-1374920-hero-01-b1463e806a7947e7b8b17979ab70eab3.jpg",
  },
  {
    ...
    image:
      "https://130529051.cdn6.editmysite.com/uploads/1/3/0/5/130529051/s444124611972565011_p236_i2_w1920.jpeg",
  },
];
