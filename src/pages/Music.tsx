    ...
    <div className="container mx-auto px-4 py-8 mt-20">
      ...
      >
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">
          ...
          us from 8pm to 11pm for some music you don't want to miss!
        </p>
      </motion.div>
      ...
      >
        <Card>
          ...
          <CardContent>
            <p className="mb-4">
              Stay tuned for more exciting performances in the coming months!
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>Open Mic Nights every Wednesday</li>
              <li>Local Artist Showcase last Saturday of each month</li>
