...
import { Calendar, Coffee, MapPin, Mic, Music, Phone } from "lucide-react";
			...
			<main className="container mx-auto py-16">
				...
				>
					...
					<p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
						Where every cup tells a story, and every visit becomes a
						cherished memory.
					</p>
					<Button
						size="lg"
				...
				>
					...
					<div className="md:w-1/2 md:pl-8">
						...
						<p className="text-gray-600 dark:text-gray-300 mb-6">
							Step into a world where the aroma of freshly brewed
							coffee mingles with the sounds of gentle music. Our
							cozy nooks and communal spaces are designed for both
							solitary reflection and lively conversations.
						</p>
						<div className="space-y-2 text-gray-600 dark:text-gray-300">
							<div className="flex items-center">
								<MapPin className="h-5 w-5 mr-2 text-gray-500" />
								<span>
									54321 Route 42, Ellison Bay, WI 54210
								</span>
							</div>
							<div className="flex items-center">
